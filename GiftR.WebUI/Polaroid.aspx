<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Polaroid.aspx.cs" Inherits="GiftR.WebUI.Polaroid" %>
...
<head>
    ...
    <script type="text/javascript" src="Scripts/jquery.transform-0.8.0.min.js"></script>
    <script type="text/javascript">
        ...
        $(function () {
            ...
            function showImage(nav) {
                ...
                var imgL_photoId = $thumb.attr('id');
        ...
        <div id="pp_thumbContainer">
            <div class="album">
                <asp:Repeater runat="server" ID="rptAlbum">
                    <ItemTemplate>
                        <div class="content">
                            <img src='<%# Eval("Src") %>' alt='<%# Eval("Alt") %>' id='<%# Eval("Id") %>' />
                            <span>
                                <%# Eval("Title") %></span>
                        </div>
                    </ItemTemplate>

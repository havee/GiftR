			...
			positionImages: function(el) {
				...
				$(el)
					...
					.find('img')
						.removeAttr('height')
						.each(function (nr) {          
                            this.spacegallery.origWidth = 900;
						    var newWidth = this.spacegallery.origWidth - 
                                                (this.spacegallery.origWidth - this.spacegallery.origWidth * el.spacegalleryCfg.minScale) * el.spacegalleryCfg.asins[nr];
							$(this)
								.css({
